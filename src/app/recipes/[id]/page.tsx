...
import { SupabaseRecipe, MealDBResponse, MealDBRecipe } from "../../../types";
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-3">
                  {recipe.ingredients?.map((item: string, index: number) => (
                    <div
                      key={index}
                      className="flex items-start space-x-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-orange-50 dark:hover:bg-orange-900/10 transition-colors"
                    >
